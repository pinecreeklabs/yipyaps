...
export function LocationPromptModal({ open, onLocationGranted, error: externalError }: LocationPromptModalProps) {
        ...
        <Dialog open={open}>
            <DialogContent showCloseButton={false} className="text-center">
                <DialogHeader className="items-center">
                    <DialogTitle className="font-display text-3xl">Welcome to Yipyaps</DialogTitle>
                    <DialogDescription className="text-base">
                        {state === 'initial' && 'Share quick notes with people nearby. Enable location to get started.'}
                ...
                <div className="mt-4 flex justify-center">
                    ...
                    {state === 'error' && (
                        <Button onClick={handleEnableLocation} size="lg" variant="outline" className="font-medium">
                            Try again
                        </Button>
                    )}
                </div>
