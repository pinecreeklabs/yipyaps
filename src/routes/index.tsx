...
import { usePosts, useCreatePost } from "@/lib/tanstack/hooks/use-posts";
...
function Home() {
  ...
  const { mutate: createPostMutation, isPending: isCreatingPost } =
    useCreatePost(userLocation);
  ...
  const handlePost = async () => {
    const cantPost =
      !noteText.trim() || isCreatingPost || charCount > 140 || !userLocation;
              ...
              <Card className="mb-16 rotate-[-1deg] border-2 border-secondary/30 bg-secondary/10 p-6 shadow-lg transition-transform hover:scale-[1.01] dark:bg-secondary/5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    onClick={handlePost}
                    disabled={
                      !noteText.trim() || charCount > 140 || isCreatingPost
                    }
